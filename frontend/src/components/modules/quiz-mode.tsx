...
export function QuizModeModule() {
  ...
  return (
    <RequireAuth>
      ...
      >
        <Card className="border-primary/15 bg-gradient-to-br from-indigo-500/20 via-violet-400/10 to-purple-600/25 lg:col-span-2">
          ...
          <Card>
            <CardHeader className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
              <div className="flex flex-wrap items-center gap-2">
                <Badge variant="outline" className="uppercase tracking-wide">Session controls</Badge>
              </div>
              <div className="flex flex-wrap items-center gap-2">
